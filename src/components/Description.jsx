...
export default function Description({product}) {
  ...
  return (
    ...
    onClick={()=>setReadMore(s=>!s)}>
      <h2 className='font-sans font-regular text-[1.5rem] text-[#212121]'>Description</h2>
      <p className='text-darkTransparent text-[1rem] mt-2 leading-relaxed tracking-normal text-justify'>{product.description}</p>
